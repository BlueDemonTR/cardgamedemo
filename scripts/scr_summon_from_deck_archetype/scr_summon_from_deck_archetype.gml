function scr_summon_from_deck_archetype(filter_archetype1, filter_archetype2, targetMinLevel, targetMaxLevel, activatedCard) {

	global.effect_successful = true;
	obj_player.mid_effect= true;
	scr_filter_archetype(filter_archetype1,filter_archetype2,targetMinLevel,targetMaxLevel,true);
