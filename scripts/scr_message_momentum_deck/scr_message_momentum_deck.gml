function scr_message_momentum_deck() {
	...
	for(var i = 0; i < obj_player.momentumDeckCount; i++){
		buffer_write(obj_client.send_buffer, buffer_u32, obj_player.momentum_deck[i, CardNumber]);
		buffer_write(obj_client.send_buffer, buffer_u8, obj_player.momentum_deck[i, ArtNumber]);
	}
