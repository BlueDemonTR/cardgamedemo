function scr_miscellaneous_target(argument0,argument1,argument2,argument3,argument4,argument5,argument6,argument7) {
	...
	activatedCardLocation = argument6,
	ignoreTarget = argument7; //-1 if none
