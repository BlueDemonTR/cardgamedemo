function scr_message_opponent_momentum_deck() {
	...
	for(var i = 0; i < obj_opponent.momentumDeckCount; i++){
		buffer_write(obj_client.send_buffer, buffer_u32, obj_opponent.momentumDeck[i, 0]);
		buffer_write(obj_client.send_buffer, buffer_u32, obj_opponent.momentumDeck[i, 1]);
	}
