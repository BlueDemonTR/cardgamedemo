if(current_function == TargetDiscard && instance_exists(obj_player.handCard[position])){
...
if (current_function == TargetDirect && sprite_index != spr_select_player_selected){
