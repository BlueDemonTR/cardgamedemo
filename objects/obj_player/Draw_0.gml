...
draw_text_transformed_color(1450,525,string(mana),5,5,0,c_purple,c_purple,c_fuchsia,c_fuchsia,1);
draw_text(1335, 735,string(playerHP)+"/"+string(playerMaxHP));
if(own_turn){
	if(mid_effect){
		draw_rectangle_color(1200,room_height/2-75,1350,room_height/2+75,c_orange,c_orange,c_orange,c_orange,false)
		draw_text(1210,room_height/2-16,"Mid Effect")
	}else{
...
if(test_mode){
	...
	if(instance_exists(obj_opponent)){
		draw_set_font(fnt_default)
		draw_text(100,260,opponent.hand)
		draw_text(100,200,hand)
		draw_text(100,170,handCount)
		draw_text(100,230,handCard)
		draw_text(1500,140,resolutionPile)
		draw_text(1500,120,resolutionPileCount)
		draw_text(1500,160, string(open_game_state) + string(!opponent_response_left) + string(!player_response_left))
	}
}
